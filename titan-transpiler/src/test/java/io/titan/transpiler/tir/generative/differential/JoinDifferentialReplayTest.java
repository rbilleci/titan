...
class JoinDifferentialReplayTest {
    ...
    @Test
    void replaysRequestedJoinSeed() throws Exception {
        ...
        try (Connection connection = DriverManager.getConnection(
            ...
            var run = new JoinPostgresSqlHarness().runJoinCase(
                    connection,
                    switch (profile) {
            ...
            assertNull(run.mismatchSummary(), "Join replay mismatch artifacts=" + run.artifactDir());
        }
    }
}
